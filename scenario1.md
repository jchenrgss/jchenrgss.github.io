...
$$\Delta\rightarrowover{d}=\frac{{\rightarrowover{v}_i}^2\sin2\theta}{g}$$
$\text{Use *Nagato*'s maximum gun elevation, because as }\theta\text{ increases, }\sin2\theta\text{ increases to approximately }0.57$
$\text{ }\\$
</p>
</body>
</html>
